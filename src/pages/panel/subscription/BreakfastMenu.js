...
const BreakfastMenu = () => {
  return (
    <React.Fragment>
      ...
      <Content>
        <BlockHead size="lg">
          <div className="nk-block-head-sub"><span>Breakfast Category</span></div>
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle tag="h2" className="fw-normal">View Breakfast Menu</BlockTitle>
              <BlockDes>
                  ...
                  <Card className={`card-bordered pricing text-center ${item.tags ? "recommend" : ""}`}>
                    ...
                    <div className="pricing-body">
                      ...
                      <div className="pricing-title w-220px mx-auto">
                        <h5 className="title">Coffee</h5>
                        <span className="sub-text">Hot black coffee to light up your world</span>
                      ...
                      <div className="pricing-amount">
                        ...
                        <span className="bill">{item.userNumber} cup, Billed Yearly</span>
                      </div>
