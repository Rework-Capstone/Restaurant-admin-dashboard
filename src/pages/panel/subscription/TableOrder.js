...
const TableOrder = () => {
  return (
    <React.Fragment>
      ...
      <Content>
        <BlockHead size="lg">
          <div className="nk-block-head-sub"><span>Table Orders</span></div>
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle tag="h2" className="fw-normal">View Tables</BlockTitle>
              <BlockDes>
                <p>You can change your table price as desired.</p>
              </BlockDes>
            </BlockHeadContent>
          </BlockBetween>
        </BlockHead>
                  ...
                  <Card className={`card-bordered pricing text-center ${item.tags ? "recommend" : ""}`}>
                    ...
                    <div className="pricing-body">
                      ...
                      <div className="pricing-title w-220px mx-auto">
                        ...
                        <span className="sub-text">This is our VIP table for extinguished customers</span>
                        {/* <h5 className="title">{item.title}</h5>
                        <span className="sub-text">{item.desc}</span> */}
                      </div>
                      <div className="pricing-amount">
                        <div className="amount">
                          ${item.amount} <span>/table</span>
                        </div>
                        <span className="bill">{item.userNumber} tables ordered</span>
                      </div>
                      <div className="pricing-action">
                        {/* <ul className="">
                          <Link to={`${process.env.PUBLIC_URL}/subscription/create-staff`} className="btn btn-primary">Breakfast Menu</Link>
                        </ul> */}
